    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild>
        <Button
          variant="default"
          size="sm"
          className="flex items-center gap-2 bg-gray-600 hover:bg-black text-white">
        ...
        {activeTab === "profile" && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-xl font-bold text-center break-words max-w-full">
                {data.fullname}
              </h2>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <Button
                    ...
                    className="flex-shrink-0"
                    onClick={() =>
                      copyToClipboard(data.mobile, "Mobile Number")
                    }>
                    <Clipboard className="h-4 w-4" />
                  </Button>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {data.profileImage && (
              <div>
                ...
                <div className="relative w-full h-[300px]">
                  <Image
                    src={`${getImage(data.profileImage)}` || "/placeholder.svg"}
                    alt="Profile"
                    fill
            ...
            {data.idProof && (
              <div>
                ...
                <div className="relative w-full h-[300px]">
                  <Image
                    src={getImage(data.idProof) || "/placeholder.svg"}
                    alt="ID Proof"
                    fill
                    className="object-contain rounded-lg shadow-md"
                  />
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              {data.additionalDetails?.dateOfBirth && (
                <p className="flex flex-col sm:flex-row sm:gap-2">
                  <strong className="inline-block min-w-24">
                    Date of Birth:
                  </strong>
                  <span className="text-sm">
                    {formatDate(data.additionalDetails.dateOfBirth)}
                  </span>
                </p>
              )}
            </div>
