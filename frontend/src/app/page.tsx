      ...
      <section className="py-20 bg-gray-900/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Discover our most popular learning tools and resources designed to accelerate your skill development.</p>
          </div>
          
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Product Card 1 */}
            <Products category='Live Workshops' orderCount={100} id='1234' price='1000' smallDiscroption='Join industry experts in real-time collaborative sessions' url='fasdgads' key={1}/>
            {/* <Products category='Live Workshops' orderCount={100} id='1234' price='1000' smallDiscroption='Join industry experts in real-time collaborative sessions' url='fasdgads' key={1}/> */}
            {/* <Products category='Live Workshops' orderCount={100} id='1234' price='1000' smallDiscroption='Join industry experts in real-time collaborative sessions' url='fasdgads' key={1}/> */}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Choose the perfect plan for your learning goals and budget.</p>
          </div>
